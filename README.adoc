...
image:https://img.shields.io/github/actions/workflow/status/lammermann/literate_programming_toolsuite/rust.yml?style=flat-square[link=https://github.com/lammermann/literate_programming_toolsuite/actions]
