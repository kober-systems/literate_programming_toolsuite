...
https://www.rust-lang.org/[rust] besser kennenlernen will und mit <<../asciidoctrine/asciidoctrine.adoc#, asciidoctrine>> einen
...
----
<1> Da `lisa` eine <<../asciidoctrine/asciidoctrine.adoc#, asciidoctrine>> Erweiterung ist, implementiert das
...
<5> Oftmals ist die <<snippet_topo_sort, Reihenfolge der Abarbeitung der Code-Schnipsel>> entscheidend. Diese wird vor der Abarbeitung festgelegt.
