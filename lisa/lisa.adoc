...
Snippet haben. In diesem Fall kann man das Attribut `lisa-raw` übergeben
...
homepage = "https://kober-systems.github.io/literate_programming_toolsuite/lisa/lisa.html"
