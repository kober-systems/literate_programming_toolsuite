...
Dazu verwenden wir https://kober-systems.github.io/literate_programming_toolsuite/lisa/lisa.html[lisa] (welches im gleichen Repo verwaltet wird) als Werkzeug.
